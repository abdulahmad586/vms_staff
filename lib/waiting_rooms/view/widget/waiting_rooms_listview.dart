...
class WaitingRoomsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<WaitingRoomListCubit>(
      create: (context) =>
          WaitingRoomListCubit(WaitingRoomListState(), refreshController),
          ...
          return SmartRefresher(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Expanded(
                    child: state.rooms == null || state.rooms!.isEmpty
                        ? (state.error != null
                            ? ErrorPage(
                                message: state.error!,
                                onContinue: () {
                                ...
                                trailing: Card(
                                  child: Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 10.0),
                                    child: Text(
                                      state.rooms![index].queueSize.toString(),
